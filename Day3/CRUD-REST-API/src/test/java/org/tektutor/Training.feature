Feature: Develop a REST API that supports CRUD operations.
   ...
   Scenario: Should be able to retrieve all training records
     ...
     Given there is a REST API that supports retrieve all training records at "http://localhost:8080/tektutor-crud-api-1.0.0/rest/trainings/all"
   ...
   Scenario: Should be able to retrieve a specific training record
     ...
     Given there is a REST API that supports retrieving a specific training record at "http://localhost:8080/tektutor-crud-api-1.0.0/rest/trainings/1"
     When I invoked the REST endpoint with GET method
     Then I expect the response code as "200"
